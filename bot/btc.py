...
async def fetch_btc_price():
    """
    Multi-source BTC price fetcher.
...
async def fetch_candles():
    """
    Fetch BTC candles from Coinbase.
    """
...
async def build_btc_model(market=None):
    ...
    vol_cal = historical_volatility_calibration(
        candles
    )
