...
def _candidate_slugs(asset: str = "btc", duration: int = 15) -> List[str]:
    ...
    Docs/example repos show this pattern.
    We test previous/current/next windows because Gamma indexing can lag.
    """
...
async def discover_btc_15m_market() -> Dict[str, Any]:
    ...
    async with httpx.AsyncClient(timeout=10, headers=headers) as client:
        ...
        # Primary: deterministic current/nearby slug.
