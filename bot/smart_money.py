...
SCORE_FLOOR_FOR_CONSENSUS = 40.0   # only wallets >= this contribute to consensus
MIN_CONSENSUS_WALLETS = 2           # minimum smart wallets overlapping a position
MIN_CONSENSUS_VALUE = 50.0          # min total USD across all wallets in signal
